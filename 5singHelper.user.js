...
function main(){
    ...
    function createOption(divSet){
        var sHtml = [
            ...
            '    <span>项目主页：</span><br /><a href="https://github.com/heroesm/5singHelper">https://github.com/heroesm/5singHelper</a>',
            '    <br />',
            '    <span>问题反馈：</span><br /><a href="https://greasyfork.org/zh-CN/scripts/17648-5sing%E5%8A%A9%E6%89%8B/feedback">https://greasyfork.org/zh-CN/scripts/17648-5sing%E5%8A%A9%E6%89%8B/feedback</a>',
            '</p>',
            '</div>',
    ...
    function setUpUI() {
        ...
        style.innerHTML = [
            ...
            '.helper_container * {color: black !important}',
            '.helper_container p {}',
